# vamshop_template_molodezky
 ...
 Стартовый шаблон для актуальной версии (1.99) на основе фреймверка Bootstrap 3.3.7. Используется для натяжки дизайна на CMS Vamshop.
 -
 ...
 11. \media\content\sitemap.php - закомментирован вывод третьего и ниже уровня категорий
