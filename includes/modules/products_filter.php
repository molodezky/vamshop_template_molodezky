...
*/
  ...
  if (SPECIFICATIONS_FILTERS_MODULE == 'True') {
    ...
    $box_text .= '<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 filter">';
      ...
      if ($count_filters >= SPECIFICATIONS_FILTER_MINIMUM) {
        ...
        if (isset ($_GET[$var]) && $_GET[$var] != '') {
        $box_text .=  '<b>' . $specs_array['specification_name'] . '</b> <a href="'.vam_href_link (FILENAME_PRODUCTS_FILTERS, vam_get_all_get_params (array ('f' . $specs_array['specifications_id']) ) ).'"><span class="filter-close circle text-danger cart_delete"><i class="fa fa-times"></i></span></a><br />';
        } else {
...
//          $filters_select_array[$filter_index] = array ('id' => rawurlencode ($previous_filter_id),
    ...
    $box_text .= '<div class="clearfix"></div>';
