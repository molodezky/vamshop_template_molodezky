...
//        $$var = vam_clean_get__recursive($$var);
      ...
      if ($count_filters >= SPECIFICATIONS_FILTER_MINIMUM) {
        ...
        if (isset($_GET[$var]) && $_GET[$var] != '') {
        $box_text .=  '<b>' . $specification['specification_name'] . '</b> <a href="' . vam_href_link(FILENAME_PRODUCTS_FILTERS, vam_get_all_get_params(array('f' . $specification['specifications_id']) ) ) . '"><span class="close-box"><i class="fa fa-times"></i></span></a><br />';
        } else {
