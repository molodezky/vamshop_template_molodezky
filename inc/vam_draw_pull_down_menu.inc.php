...
// Output a form pull down menu
  function vam_draw_pull_down_menu($name, $values, $default = '', $parameters = '', $required = false) {
    $field = '<select class="form-control" name="' . vam_parse_input_field_data($name, array('"' => '&quot;')) . '"';
...
// End Products Specifications
    ...
    $field = '<select class="form-control" name="' . vam_parse_input_field_data($data['name'], array('"' => '&quot;')) . '"';
