...
// Output a form input field
  function vam_draw_input_field($name, $value = '', $parameters = '', $type = 'text', $reinsert_value = true) {
    $field = '<input class="form-control" type="' . vam_parse_input_field_data($type, array('"' => '&quot;')) . '" name="' . vam_parse_input_field_data($name, array('"' => '&quot;')) . '"';
    ...
    $field = '<input class="form-control" type="' . vam_parse_input_field_data($type, array('"' => '&quot;')) . '" name="' . vam_parse_input_field_data($data['name'], array('"' => '&quot;')) . '"';
