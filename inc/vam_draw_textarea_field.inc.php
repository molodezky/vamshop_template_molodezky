...
// Output a form textarea field
  function vam_draw_textarea_field($name, $wrap, $width, $height, $text = '', $parameters = '', $reinsert_value = true) {
    $field = '<textarea class="form-control" name="' . vam_parse_input_field_data($name, array('"' => '&quot;')) . '" id="' . vam_parse_input_field_data($name, array('"' => '&quot;')) . '" cols="' . vam_parse_input_field_data($width, array('"' => '&quot;')) . '" rows="' . vam_parse_input_field_data($height, array('"' => '&quot;')) . '"';
