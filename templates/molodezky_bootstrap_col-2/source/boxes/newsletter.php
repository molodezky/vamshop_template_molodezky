...
$box->assign('FIELD_EMAIL', '<input class="form-control" type="text" name="email" placeholder="Введите Ваш Email...">');
$box->assign('BUTTON', '<button type="submit" class="btn btn-info">Подписаться</button>');
